...
def bench_sgmv(f):
    ...
    for h1, pop, bs in (pbar := tqdm(all_)):
        ...
        # # Note: bench_2 is not defined in the original code, so I'm commenting it out
        # latency_2 = bench(
        #     lambda: punica.ops.sgmv_cutlass_answer(y, x, w_ptr, s, layer_idx=0),
        #     warmup=200,
        #     repeat=1000,
        # )
        ...
        #     "latency_2": {
        #         "avg": latency2.avg(),
        #         "std": latency2.std(),},  # Commented out as bench_2 is not defined
        }
