...
bool sgmv(DType *y, DType *x, DType **w, int32_t *s, void *tmp_d,
  ...
  // Optimized GemmKernel configuration based on auto-scheduler results
  using GemmKernel = typename cutlass::gemm::kernel::DefaultGemmGrouped<
      ...
      cutlass::gemm::GemmShape<32, 64, 64>,           // Warp Shape
      cutlass::gemm::GemmShape<16, 8, 8>,             // Instruction Shape
      LinearCombination<cutlass_t, 8, float, float>,  // Epilogue
      GemmIdentityThreadblockSwizzle<8>,              // Swizzling Operator
      3                                               // Stages
      >::GemmKernel;

  using EpilogueOutputOp = typename GemmKernel::Epilogue::OutputOp;
  typename EpilogueOutputOp::Params epilogue_op(1.0f, 0.0f);

  using GemmGrouped = cutlass::gemm::device::GemmGrouped<GemmKernel>;
  typename GemmGrouped::Arguments args(all_problems, num_problems, 4096,
